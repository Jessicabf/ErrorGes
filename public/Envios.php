...
limit 10";
        ...
        <table border=1 cellspacing=1 cellpadding=0>
            ...
            <tr>
                ...
                <td><?php echo $fecha = $result['fecha_envio']; ?></td>
                <td><?php echo $mayorista = $result['mayorista']; ?></td>
                <td><?php echo $errores = $result['errores']; ?></td>
                <td><?php echo $hoteles = $result['hoteles']; ?></td>
