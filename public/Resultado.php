...
";
    ...
    ?>
       ...
       <button id='button' type="submit"
                onclick="console.log('https://dev7.secure.centraldereservas.com/~isabel/sr-master/cliente.cgi?tipo=' + tipo_busqueda + '&lang=' + idioma + '&id=' + entidad + '&rf=' +referer + '&fecha_entrada=' + fecha_entrada_dispo + '&fecha_salida=' + fecha_salida_dispo + '&numero_habs=1&no_adultos_hab1=2&auto=1');window.open('https://dev7.secure.centraldereservas.com/~isabel/sr-master/cliente.cgi?tipo=' + tipo_busqueda + '&lang=' + idioma + '&id=' + entidad + '&rf=' +referer + '&fecha_entrada=' + fecha_entrada_dispo + '&fecha_salida=' + fecha_salida_dispo + '&numero_habs=1&no_adultos_hab1=2&auto=1', '_blank')">
            Repetir búsqueda
        </button>
